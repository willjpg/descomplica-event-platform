        ...
        <div className="flex-1">
            ...
            <div className="p-8 max-w-[1100px] mx-auto">
                <div className="flex items-start gap-16">
                    <div className="flex-1">
                        <h1 className="text-2xl font-bold">Aula 01 - Abertura do Ignite Lab
                        ...
                        <div className="flex items-center gap-4 mt-6">
                            <img
                                ...
                                src="https://avatars.githubusercontent.com/u/102267555?v=4"
                                alt="" />

                            <div className="leading-relaxed">
                                <strong className="font-bold text-2xl block">Willian Ferreira</strong>
