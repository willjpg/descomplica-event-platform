 ...
 * });
 */
export function useGetQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonsQuery, GetLessonsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export type GetLessonsQueryHookResult = ReturnType<typeof useGetQuery>;
